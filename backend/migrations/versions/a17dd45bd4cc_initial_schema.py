...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_diary_user_id")}')
    op.execute("DROP TABLE IF EXISTS diary CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_sync_sessions_user_id")}')
    op.execute("DROP TABLE IF EXISTS sync_sessions CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_align_sessions_user_id")}')
    op.execute("DROP TABLE IF EXISTS align_sessions CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_voice_records_user_id")}')
    op.execute("DROP TABLE IF EXISTS voice_records CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_user_portrait_user_id")}')
    op.execute("DROP TABLE IF EXISTS user_portrait CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_patterns_user_id")}')
    op.execute("DROP TABLE IF EXISTS patterns CASCADE")
    op.execute("DROP TABLE IF EXISTS natal_charts CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_matches_user_id_2")}')
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_matches_user_id_1")}')
    op.execute("DROP TABLE IF EXISTS matches CASCADE")
    op.execute("DROP TABLE IF EXISTS game_state CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_daily_reflect_user_id")}')
    op.execute("DROP TABLE IF EXISTS daily_reflect CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_connections_user_id")}')
    op.execute("DROP TABLE IF EXISTS connections CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_card_progress_user_id")}')
    op.execute("DROP TABLE IF EXISTS card_progress CASCADE")
    op.execute(f'DROP INDEX IF EXISTS {op.f("ix_users_tg_id")}')
