...
{{
  ...
  "about": "Личностный нарратив об энергии сферы. Пиши НАПРЯМУЮ пользователю, в тёплом и глубоком тоне: 'В тебе живёт энергия...', 'Ты несёшь в себе...', 'Твоя природа в этой сфере...'. 2-3 предложения. Это — зеркало, в которое смотрит человек.",
  "insight": "Суть сферы в 1-2 предложениях. Самое главное.",
  "light": "Глубокий разбор Света: таланты, высшее предназначение (200-400 знаков).",
  "shadow": "Глубокий разбор Тени: страхи, саботаж, слепые пятна (200-400 знаков).",
  "evolutionary_task": "Конкретный духовный и экзистенциальный урок этой сферы.",
  "life_hacks": ["Практический шаг 1", "Практический шаг 2", "Практический шаг 3"],
  "astrological_markers": ["Планета X в доме Y", "Аспект A к B"],
  "resonance": 0-100,
  "weighted_resonance": [
    {{"archetype_id": 1, "weight": 95, "reason": "Управитель дома"}}
  ]
}}
...
async def synthesize_deep_sphere(sphere_key: str, chart_dict: dict, aspects_dict: list) -> dict:
    ...
    try:
        ...
        return {
            "status": "В обработке",
            "about": "Твоя энергия в этой сфере сейчас формируется...",
            "insight": "Глубинные данные формируются...",
            "light": "...",
            "shadow": "...",
            "evolutionary_task": "...",
            "life_hacks": [],
