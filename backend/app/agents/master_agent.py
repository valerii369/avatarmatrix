...
""",
        "mirror": f"""
ФИНАЛ — ЗЕРКАЛО (ГЛУБОКАЯ ДИАГНОСТИКА)
Твоя задача — объективный и беспощадный анализ всей сессии для определения реального уровня сознания (Хокинс).

МЕТРИКИ АНАЛИЗА:
1. КЛЮЧЕВОЙ ВЫБОР (Слой 3 — Разлом): Это момент истины. Что выбрал человек, когда "всё сломалось"? Это показывает его базовую стратегию выживания или роста. Оцени балл Хокинса в этой точке как приоритетный.
2. СЕНСОРНЫЙ ФОН (Слои 1, 2, 4): Какие детали называл человек? Тьма, холод, сжатость (низкий Хокинс <100) или свет, движение, расширение (высокий Хокинс >250).
3. ПАТТЕРН ТЕНИ: Что повторяется? Избегание, агрессия, замирание или любопытство?

ШКАЛА ХОКИНСА (Маркеры):
- 20-50 (Стыд/Вина/Апатия): Сломленность, "я ничто", "всё бесполезно".
- 75-100 (Горе/Страх): Утрата, тревога, "а вдруг", зажатость.
- 125-175 (Желание/Гнев/Гордыня): Жажда обладания, обвинение других, превосходство.
- 200-350 (Смелость/Нейтральность/Принятие): "Я попробую", "это нормально", "я благодарен".
- 400+ (Разум/Любовь): Системное понимание, глубокий покой, отсутствие деления на плоское "хорошо/плохо".

ЗАДАЧА:
Найди НАЙНИЗШУЮ точку погружения (самый низкий балл Хокинса), которую человек проявил в ответах. Это и есть активная Тень.

JSON:
{{
  "real_picture": "что на самом деле происходит в подсознании",
  "core_pattern": "название паттерна (например: 'Замирание в ожидании удара')",
  "shadow_active": "какое теневое качество архетипа проявлено сейчас",
  "key_choice": "анализ выбора на Разломе",
  "recurring_symbol": "главный объект/символ и его значение",
  "first_insight": "глубокий инсайт для пользователя в 1 предложение",
  "hawkins_score": 100,
  "hawkins_level": "уровень из шкалы"
}}
"""
    }
