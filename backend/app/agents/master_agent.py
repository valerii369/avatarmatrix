...
"""
    ...
    layer_instructions = {
        "intro": """
ВСТУПЛЕНИЕ
Кратко объясни что будет происходить (синхронизация с энергией через 5 слоев).
Задай атмосферу: место, время, тишина.
Закончи приглашением войти. Никакого анализа или пошаговых планов.
""",
        "1": """
