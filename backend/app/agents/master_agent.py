...
""",
        "5": """
СЛОЙ 5 — ЯДРО (ФОРМУЛА ЭНЕРГИИ)
Здесь — точка сборки. Всё предыдущее (образы, выборы) сжимается в одну точку.
Вопрос: Если бы твоё состояние сейчас было ОДНИМ звуком или ОДНИМ физическим материалом — что бы это было? Кратко.
""",
        "mirror": f"""
ФИНАЛ — ЗЕРКАЛО (ЭКСПЕРТНЫЙ АНАЛИЗ — 6 ШАГОВ)
Твоя задача — провести глубокую дешифровку сессии (Вступление + 5 слоев) по шкале Хокинса.
Не верь словам пользователя ("мне хорошо"), верь СЕНСОРИКЕ его ответов.

АЛГОРИТМ ОЦЕНКИ:
1. АНАЛИЗ РАЗЛОМА (Слой 3): Это 50% веса оценки. Базовая стратегия (страх/гнев/смелость).
2. АНАЛИЗ ЯДРА (Слой 5): Это 30% веса оценки. Финальная "плотность" и "вибрация" образа.
3. СЕНСОРНЫЙ ВЕС (Слои 1, 2, 4): Динамика против статики, холод против тепла.
4. АРХЕТИПИЧЕСКОЕ СООТВЕТСТВИЕ: Насколько образы коррелируют с Тенью или Светом текущего Архетипа.
