...
async def run_avatar_layer(
    ...
    if layer != "intro":
        if previous_messages:
            # If the first message in history is 'user', and we just had a SYSTEM prompt,
            # that's fine. But if we want to be safe and consistent with the 'intro' logic:
            # The 'intro' was generated by AI, but might not be in the transcript 
            # if the session was just started.
